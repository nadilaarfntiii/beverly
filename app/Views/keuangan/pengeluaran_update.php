...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"> Form Ubah Pengeluaran </h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                        <form action="/pengeluaran/update/<?= $pengeluaran['id_transaksi']; ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="id_kategori" name="id_kategori">
                                        ...
                                        <?php foreach ($kategori as $kat) : ?>
                                            <option value="<?= $kat['id_kategori']; ?>" <?= ($kat['id_kategori'] == $pengeluaran['id_kategori']) ? 'selected' : ''; ?>>
                                                <?= $kat['nm_kategori']; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" id="berkas" name="berkas" value="<?= $pengeluaran['berkas']; ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="id_user" name="id_user" disabled>
                                        ...
                                        <?php foreach ($user as $u) : ?>
                                            <option value="<?= $u['id_user']; ?>" <?= ($u['id_user'] == $pengeluaran['id_user']) ? 'selected' : ''; ?>>
                                                <?= $u['nama']; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
