                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tambah Pengajuan Pembelian</h6>
                        </div>
                        <div class="card-body">
                    ...
                    <form action="<?php echo base_url('/pembelian/store'); ?>" method="post">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="validationCustom01" class="form-label">Upload Berkas</label>
