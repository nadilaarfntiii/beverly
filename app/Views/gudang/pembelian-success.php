                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Berhasil Ajukan</h6>
                        </div>
                        <div class="card-body pt-5">

                            <div class="text-center p-5">
                                <h4>Selamat, Data Pembelian Berhasil Diajukan!</h4>
                            </div>

                            <a href="/pembelian" class="mt-5 btn btn-success mb-3">OKE</a>
