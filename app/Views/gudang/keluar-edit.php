        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="<?php echo base_url('/barang_keluar/edit/' . $keluar['id_brg_klr']); ?>" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="id_brg_msk" placeholder="" id="validationCustom01"
                                        value="<?= $keluar["id_brg_klr"] ?>" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_brg" id="" class="form-control">
                                        ...
                                        <?php foreach ($barang as $item) : ?>
                                            <option value="<?= $item['id_brg'] ?>" <?= $item['id_brg'] == $keluar['id_brg'] ? "selected" : "" ?> ><?= $item["nm_brg"] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
