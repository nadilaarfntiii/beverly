        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= base_url('pengajuan') ?>">Ajukan Stok</a>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">6 Ton</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Produksi Harian</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">4 Ton</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <!-- <div class="card-body">
                                    <h4 class="small font-weight-bold">Teh oolong <span
                                            class="float-right">48%</span></h4>
                                    ...
                                    <h4 class="small font-weight-bold">Teh Hitam <span
                                            class="float-right">78%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-warning" role="progressbar" style="width: 78%"
                                            aria-valuenow="78" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <h4 class="small font-weight-bold">Teh Herbal<span
                                            class="float-right">67%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar" role="progressbar" style="width: 67%"
                                            aria-valuenow="67" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <h4 class="small font-weight-bold">Teh Melati <span
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Tentang Perusahaan</h6>
                                </div>
                                <div class="card-body">
                                    <p>PT Beverly International adalah perusahaan yang bergerak dalam produksi teh dengan 
                                        berbagai macam merek. Berdiri sejak tahun 1980, perusahaan ini telah menjadi salah 
                                        satu pemain utama dalam industri teh di Indonesia.</p>
                                    <p class="mb-0"> <b>"Produksi adalah kunci untuk mencapai tujuanmu. Teruslah bergerak dan jangan 
                                        pernah menyerah."</b> - Henry Ford</p>
                                </div>
                            </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; FAHRIA KARIMA (SISTEM PRODUKSI)</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
