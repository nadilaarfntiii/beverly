...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Pengajuan Stok Produksi</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="/pengajuan/create" class="btn btn-primary float-right">Ajukan Stok</a>
                            <h5>
                                Daftar Pengajuan Stok Produksi
                            </h5>
                        </div>
                        <div class="card-body">
