...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"> Buat Laporan Pengeluaran </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/dashboard_k">Dashboard</a></li>
                        <li class="breadcrumb-item active">Buat Laporan Pengeluaran</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="col me-2 pb-3">
                                ...
                                <form class="d-flex float-right" role="search" action="/laporan/pengeluaran/laporan_pengeluaran" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?= base_url(); ?>lap_peng" class="btn btn-secondary float-left">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
