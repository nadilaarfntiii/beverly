                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="m-0 font-weight-bold text-primary">
                                Laporan Pengeluaran <?= format_bulan($bulan); ?>
                            </h5>
                        </div>
                        <div class="card-body">
                            ...
                            <a href="/laporan/pengeluaran/createLaporanPeng" class="btn btn-secondary float-left">Kembali</a>
                            <form action="/laporan/pengeluaran/cetak_peng" class="d-inline" target="_blank" method="post">
